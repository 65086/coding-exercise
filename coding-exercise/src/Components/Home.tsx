                  ...
                  <div className="card top-selling overflow-auto">
                    ...
                    <div className="card-body pb-0">
                      ...
                      <table className="table table-borderless">
                        ...
                        <tbody>
                          <tr>
                            <th scope="row"><a href="#"><img src={require('../assets/img/product-1.jpg').default} alt="" /></a></th>
                          ...
                          <tr>
                            <th scope="row"><a href="#"><img src={require('../assets/img/product-2.jpg').default} alt="" /></a></th>
                          ...
                          <tr>
                            <th scope="row"><a href="#"><img src={require('../assets/img/product-3.jpg').default} alt="" /></a></th>
                          ...
                          <tr>
                            <th scope="row"><a href="#"><img src={require('../assets/img/product-4.jpg').default} alt="" /></a></th>
                          ...
                          <tr>
                            <th scope="row"><a href="#"><img src={require('../assets/img/product-5.jpg').default} alt="" /></a></th>
                ...
                <div className="card-body pb-0">
                  ...
                  <div className="news">
                    <div className="post-item clearfix">
                      <img src={require('../assets/img/news-1.jpg').default} alt="" />
                      <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                      <p>Sit recusandae non aspernatur laboriosam. Quia enim eligendi sed ut harum...</p>
                    </div>

                    <div className="post-item clearfix">
                      <img src={require('../assets/img/news-2.jpg').default} alt="" />
                      <h4><a href="#">Quidem autem et impedit</a></h4>
                      <p>Illo nemo neque maiores vitae officiis cum eum turos elan dries werona nande...</p>
                    </div>

                    <div className="post-item clearfix">
                      <img src={require('../assets/img/news-3.jpg').default} alt="" />
                      <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                      <p>Fugiat voluptas vero eaque accusantium eos. Consequuntur sed ipsam et totam...</p>
                    </div>

                    <div className="post-item clearfix">
                      <img src={require('../assets/img/news-4.jpg').default} alt="" />
                      <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                      <p>Qui enim quia optio. Eligendi aut asperiores enim repellendusvel rerum cuder...</p>
                    </div>

                    <div className="post-item clearfix">
                      <img src={require('../assets/img/news-5.jpg').default} alt="" />
